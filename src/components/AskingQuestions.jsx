        ...
        <div className="bg-[#c8e1f4] font-[baloo] bg-no-repeat bg-cover min-h-screen">
            <div className="">
                ...
                <div className="flex justify-center mt-5">
                    <h1 className="bg-[#fef0f4] w-[800px] h-[200px] rounded-[30px] text-[80px] flex justify-center items-center">Asking Questions</h1>
                </div>

                <div className="flex justify-center mt-5">
                    <h1 className="bg-[#fef0f4] w-[700px] h-[100px] rounded-[30px] text-[40px] flex justify-center items-center">What is Your Name?</h1>
                </div>
                ...
                <div className="flex justify-center mt-5">
                    <h1 className="bg-[#fef0f4] w-[700px] h-[100px] rounded-[30px] text-[40px] flex justify-center items-center">What time did you Wake up?</h1>
                </div>
                ...
                <div className="flex justify-center mt-5">
                    <h1 className="bg-[#fef0f4] w-[800px] h-[200px] rounded-[30px] text-[30px] flex justify-center items-center"></h1>
                </div>
            </div>
        </div>
    )
